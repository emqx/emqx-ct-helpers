...
get_matrix(SuiteStr) ->
    SuiteJobsJsonStruts = suite_matrix(SuiteStr),
    MatrixJsonStruts = {[{<<"include">>,SuiteJobsJsonStruts}]},
    jiffy:encode(MatrixJsonStruts).

suite_matrix(SuiteStr) ->
...
matrix_as_json_str_test() ->
    JsonStr = <<"{\"include\":[{\"name\":\"mysqlV8_tls_ipv4\",\"vectors\":[\"mysqlV8\",\"tls\",",
                "\"ipv4\"],\"index\":0},{\"name\":\"mysqlV8_tls_ipv6\",\"vectors\":[\"mysqlV8\",",
                "\"tls\",\"ipv6\"],\"index\":1},{\"name\":\"mysqlV8_tcp_ipv4\",\"vectors\":",
                "[\"mysqlV8\",\"tcp\",\"ipv4\"],\"index\":2},{\"name\":\"mysqlV8_tcp_ipv6\",",
                "\"vectors\":[\"mysqlV8\",\"tcp\",\"ipv6\"],\"index\":3},{\"name\":",
                "\"mysqlV5_7_tls_ipv4\",\"vectors\":[\"mysqlV5_7\",\"tls\",\"ipv4\"],\"index\":4},",
                "{\"name\":\"mysqlV5_7_tls_ipv6\",\"vectors\":[\"mysqlV5_7\",\"tls\",\"ipv6\"],",
